...
public class GiveCoinsCommand extends SubCommand<CommandSender> {

    public GiveCoinsCommand(ProCosmeticsPlugin plugin) {
        super(plugin, "procosmetics.command.give.coins", true);
        addFlats("give", "coins");
    ...
    public void onExecute(CommandSender sender, String[] args) {
        ...
        plugin.getUserManager().getAsync(name).thenAccept(user -> {
            ...
            plugin.getEconomyManager().getEconomyProvider().addCoinsAsync(user, amount).thenAccept(result -> {
