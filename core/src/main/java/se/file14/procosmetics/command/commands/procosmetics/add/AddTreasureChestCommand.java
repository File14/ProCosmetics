...
public class AddTreasureChestCommand extends SubCommand<CommandSender> {

    public AddTreasureChestCommand(ProCosmeticsPlugin plugin) {
        super(plugin, "procosmetics.command.add.treasurechest", true);
        addFlats("add", "treasurechest");
