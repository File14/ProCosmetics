...
public class RemoveAmmoCommand extends SubCommand<CommandSender> {

    public RemoveAmmoCommand(ProCosmeticsPlugin plugin) {
        super(plugin, "procosmetics.command.remove.ammo", true);
        addFlats("remove", "ammo");
