...
public class AddCoinsCommand extends SubCommand<CommandSender> {

    public AddCoinsCommand(ProCosmeticsPlugin plugin) {
        super(plugin, "procosmetics.command.add.coins", true);
        addFlats("add", "coins");
