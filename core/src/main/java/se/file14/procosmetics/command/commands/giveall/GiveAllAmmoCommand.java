...
public class GiveAllAmmoCommand extends SubCommand<CommandSender> {

    public GiveAllAmmoCommand(ProCosmeticsPlugin plugin) {
        super(plugin, "procosmetics.command.giveall.ammo", true);
        addFlats("giveall", "ammo");
