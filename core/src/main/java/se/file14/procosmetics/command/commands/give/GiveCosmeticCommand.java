...
public class GiveCosmeticCommand extends SubCommand<CommandSender> {

    public GiveCosmeticCommand(ProCosmeticsPlugin plugin) {
        super(plugin, "procosmetics.command.give.cosmetic", true);
        addFlats("give", "cosmetic");
    ...
    public void onExecute(CommandSender sender, String[] args) {
        ...
        if (target.hasPermission(cosmeticType.getPermission())) {
            audience(sender).sendMessage(translator.translate(
                    "command.cosmetic.give.already_owned",
