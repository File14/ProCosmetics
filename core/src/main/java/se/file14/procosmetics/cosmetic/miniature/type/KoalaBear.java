...
public class KoalaBear implements MiniatureBehavior {

    private static final ItemStack HAND_ITEM = new ItemStack(Material.SUGAR_CANE);
    ...
    static {
        Color color = Color.fromBGR(128, 128, 128);
