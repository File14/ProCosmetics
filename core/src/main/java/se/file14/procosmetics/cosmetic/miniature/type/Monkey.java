...
public class Monkey implements MiniatureBehavior {

    private static final ItemStack HAND_ITEM = new ItemStack(Material.NETHER_STAR);
    ...
    static {
        Color color = Color.fromBGR(0, 76, 153);
