...
public class Doge implements MiniatureBehavior {

    private static final ItemStack HAND_ITEM = new ItemStack(Material.BONE);
    ...
    static {
        Color color = Color.fromRGB(255, 220, 130);
