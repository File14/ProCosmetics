...
public abstract class CosmeticImpl<T extends CosmeticType<T, B>,
    ...
    public void equip(boolean silent, boolean saveToDatabase) {
        ...
        PlayerPreEquipCosmeticEvent event = new PlayerPreEquipCosmeticEvent(user, player, cosmeticType);
    ...
    public void unequip(boolean silent, boolean saveToDatabase) {
        ...
        plugin.getServer().getPluginManager().callEvent(new PlayerUnequipCosmeticEvent(player, cosmeticType));
        equipped = false;
