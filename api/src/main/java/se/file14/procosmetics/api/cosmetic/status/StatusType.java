...
public interface StatusType extends CosmeticType<StatusType, StatusBehavior> {
     ...
     * This function is called at each refresh interval to produce the current text
     * to be displayed, allowing for dynamic content based on user data.
     *
     * @return the text provider function that takes a User and returns a Component
     */
    Function<User, Component> getTextProvider();
    ...
    interface Builder extends CosmeticType.Builder<StatusType, StatusBehavior, Builder> {
         ...
         * @return this builder for method chaining
         */
        Builder textProvider(Function<User, Component> textProvider);
