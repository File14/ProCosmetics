 ...
 */
public class PlayerPurchaseCosmeticEvent extends Event {
    ...
    /**
     * Constructs a new {@link PlayerPurchaseCosmeticEvent}.
     *
     * @param user         the user associated with the purchase
     * @param player       the Bukkit player who made the purchase
     * @param cosmeticType the cosmetic type that was purchased
     */
    @ApiStatus.Internal
    public PlayerPurchaseCosmeticEvent(User user, Player player, CosmeticType<?, ?> cosmeticType) {
        this.user = user;
        this.player = player;
