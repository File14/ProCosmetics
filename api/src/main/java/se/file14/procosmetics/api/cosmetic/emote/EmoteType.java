...
/**
 * Represents a type of emote cosmetic.
 */
public interface EmoteType extends CosmeticType<EmoteType, EmoteBehavior> {

    /**
     * Checks if this emote has an animation.
     *
     * @return true if the emote has animation, false otherwise
     */
    ...
    /**
     * Builder interface for constructing emote type instances.
     */
    interface Builder extends CosmeticType.Builder<EmoteType, EmoteBehavior, Builder> {
         ...
         */
        Builder tickInterval(long tickInterval);

        /**
         * Sets the complete list of animation frames for this emote.
         *
         * @param frames the list of animation frames
         * @return this builder for method chaining
         */
        Builder frames(List<AnimationFrame> frames);

        /**
         * Adds a single animation frame to this emote.
         * Frames are played in the order they are added.
         *
         * @param frame the animation frame to add
         * @return this builder for method chaining
         */
        Builder addFrame(AnimationFrame frame);
