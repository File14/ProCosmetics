...
public class NMSEntity extends NMSEntityImpl<Packet<? super ClientGamePacketListener>> {
    ...
    public NMSEntity(World world, CachedEntityType cachedEntityType, EntityTracker tracker) {
        ...
        entity = ((EntityType<?>) cachedEntityType.getEntityTypeObject()).create(((CraftWorld) world).getHandle());
    }
    ...
    public NMSEntity(World world, BlockData blockData, EntityTracker tracker) {
        ...
        try {
            entity = FALLING_BLOCK_CONSTRUCTOR.newInstance(((CraftWorld) world).getHandle(), 0.0d, 0.0d, 0.0d, ((CraftBlockData) blockData).getState());
    ...
    protected ClientboundUpdateAttributesPacket getUpdateAttributesPacket() {
        if (entity instanceof LivingEntity livingEntity) {
            Set<AttributeInstance> set = livingEntity.getAttributes().getDirtyAttributes();
    ...
    @Override
    public ClientboundTeleportEntityPacket getTeleportEntityPacket() {
